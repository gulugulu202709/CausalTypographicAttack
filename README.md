...
/disk2/anonymous/.venv/bin/python scripts/build_question_benchmark.py \
...
CUDA_VISIBLE_DEVICES=0 /disk2/anonymous/.venv/bin/python run_experiment.py --config configs/pilot_qwen25vl3b_ratio60.yaml

# Cross-fold COCO-2017-HF split ablation (same model, same sample count, disjoint images)
CUDA_VISIBLE_DEVICES=0 /disk2/anonymous/.venv/bin/python run_experiment.py --config configs/main_qwen25vl3b_n300_primary.yaml
CUDA_VISIBLE_DEVICES=0 /disk2/anonymous/.venv/bin/python run_experiment.py --config configs/main_qwen25vl3b_n300_secondary.yaml

# Build an apples-to-apples 2x300 comparison table after both folds finish
/disk2/anonymous/.venv/bin/python scripts/build_paper_table.py runs/main_qwen25vl3b_n300_primary --copy-to paper/generated_primary_results.tex
/disk2/anonymous/.venv/bin/python scripts/build_paper_table.py runs/main_qwen25vl3b_n300_secondary --copy-to paper/generated_secondary_results.tex
```
...
```bash
CUDA_VISIBLE_DEVICES=0 /disk2/anonymous/.venv/bin/python run_experiment.py --config configs/main_qwen25vl3b_n300.yaml
```
...
CUDA_VISIBLE_DEVICES=2 PYTHONPATH=/disk2/anonymous/cta_crossvl_env/lib/python3.10/site-packages \
  /disk2/anonymous/.venv/bin/python scripts/run_transfer_eval.py \
  --config configs/transfer_llavaov15_8b_n300.yaml
CUDA_VISIBLE_DEVICES=3 PYTHONPATH=/disk2/anonymous/cta_internvl_env/lib/python3.10/site-packages \
  /disk2/anonymous/.venv/bin/python scripts/run_transfer_eval.py \
  --config configs/transfer_internvl2_8b_n300.yaml

# Pascal VOC 2012, matched 300-image construction
CUDA_VISIBLE_DEVICES=0 /disk2/anonymous/.venv/bin/python run_experiment.py \
  --config configs/voc2012_qwen25vl3b_n300.yaml
CUDA_VISIBLE_DEVICES=2 PYTHONPATH=/disk2/anonymous/cta_crossvl_env/lib/python3.10/site-packages \
  /disk2/anonymous/.venv/bin/python scripts/run_transfer_eval.py \
  --config configs/transfer_llavaov15_voc2012_n300.yaml
CUDA_VISIBLE_DEVICES=6 /disk2/anonymous/.venv/bin/python scripts/run_transfer_eval.py \
...
```bash
/disk2/anonymous/.venv/bin/python scripts/prepare_natural_render_source.py \
...
PYTHONPATH=/disk2/anonymous/scenetap_runtime:/disk2/anonymous/scenetap \
  /disk2/anonymous/.venv/bin/python scripts/render_scenetap_textdiffuser.py \
  --source-log runs/natural_render_source_n100/render_manifest.jsonl \
  --output-root runs/scenetap_textdiffuser_n100 \
  --scenetap-root /disk2/anonymous/scenetap \
...
CUDA_VISIBLE_DEVICES=0 /disk2/anonymous/.venv/bin/python scripts/run_transfer_eval.py \
...
```bash
/disk2/anonymous/.venv/bin/python scripts/make_human_eval_pack.py \
...
/disk2/anonymous/.venv/bin/python scripts/analyze_human_eval.py \
...
```bash
/disk2/anonymous/.venv/bin/python scripts/make_extended_paper_assets.py \
...
/disk2/anonymous/.venv/bin/python scripts/build_strong_attack_candidates.py \
...
CUDA_VISIBLE_DEVICES=7 /disk2/anonymous/.venv/bin/python scripts/run_transfer_eval.py \
...
/disk2/anonymous/.venv/bin/python scripts/select_strong_attack_policy.py \
...
/disk2/anonymous/.venv/bin/python scripts/run_transfer_eval.py --config configs/cta_v2_test_qwen3_n100.yaml
/disk2/anonymous/.venv/bin/python scripts/run_transfer_eval.py --config configs/cta_v2_test_qwen7_n100.yaml
/disk2/anonymous/.venv/bin/python scripts/run_transfer_eval.py --config configs/cta_v2_test_llava_n100.yaml
/disk2/anonymous/.venv/bin/python scripts/run_transfer_eval.py --config configs/cta_v2_test_internvl_n100.yaml
```
...
```bash
/disk2/anonymous/.venv/bin/python scripts/build_rvta_matched_manifest.py \
  --source-manifest runs/main_qwen25vl3b_n300/sample_manifest.json \
...
CUDA_VISIBLE_DEVICES=1 /disk2/anonymous/.venv/bin/python scripts/run_transfer_eval.py \
...
CUDA_VISIBLE_DEVICES=4 /disk2/anonymous/.venv/bin/python scripts/run_transfer_eval.py \
  --config configs/rvta_ablation_qwen7_n100.yaml
CUDA_VISIBLE_DEVICES=5 PYTHONPATH=/disk2/anonymous/cta_crossvl_env/lib/python3.10/site-packages \
  /disk2/anonymous/.venv/bin/python scripts/run_transfer_eval.py \
...
```bash
/disk2/anonymous/.venv/bin/python scripts/make_rvta_assets.py \
...
/disk2/anonymous/.venv/bin/python scripts/select_budgeted_policy_sequence.py \
...
CUDA_VISIBLE_DEVICES=0 /disk2/anonymous/.venv/bin/python \
...
/disk2/anonymous/.venv/bin/python scripts/analyze_budgeted_attack.py \
...
PYTHONPATH=/disk2/anonymous/cta_crossvl_env/lib/python3.10/site-packages \
/disk2/anonymous/.venv/bin/python scripts/run_typography_diversity_eval.py \
  --config configs/budgeted_neutral_voc_llava_n100.yaml

# InternVL uses its isolated dependency path.
CUDA_VISIBLE_DEVICES=6 \
PYTHONPATH=/disk2/anonymous/cta_internvl_env/lib/python3.10/site-packages \
/disk2/anonymous/.venv/bin/python scripts/run_typography_diversity_eval.py \
...
/disk2/anonymous/.venv/bin/python scripts/analyze_prompt_profiles.py \
...
/disk2/anonymous/.venv/bin/python scripts/build_source_manifest.py \
  --config configs/scei_source_coco_n2400_v2.yaml

# Plan and render the balanced 800-item / 2,400-image dataset.
CUDA_VISIBLE_DEVICES=4 /disk2/anonymous/.venv/bin/python \
...
/disk2/anonymous/.venv/bin/python scripts/audit_scei_image_dataset.py \
  /disk2/anonymous/causal_typographic_attack_artifacts/datasets/scei_reason800_coco_v2
```
...
```bash
/disk2/anonymous/.venv/bin/python scripts/run_scei_search_batch.py \
  --config configs/scei_search_v2_qwen7_coco_n50_k2.yaml

/disk2/anonymous/.venv/bin/python scripts/launch_scei_gradio.py \
...
```bash
cd /disk2/anonymous/causal_typographic_attack
/disk2/anonymous/.venv/bin/pip install -r requirements-gradio.txt
/disk2/anonymous/.venv/bin/python app.py
```
...
```bash
/disk2/anonymous/.venv/bin/python scripts/make_strong_attack_assets.py \
...
/disk2/anonymous/.venv/bin/python scripts/make_strong_extended_assets.py \
...
```bash
/disk2/anonymous/.venv/bin/python scripts/build_paper_table.py runs/pilot_qwen25vl3b --copy-to paper/generated_results_table.tex
```
...
```bash
/disk2/anonymous/.venv/bin/python scripts/make_paper_assets.py \
...
```bash
CUDA_VISIBLE_DEVICES=7 /disk2/anonymous/.venv/bin/python \
...
```bash
PYTHONPATH=work/rapidocr_deps /disk2/anonymous/.venv/bin/python \
...
CUDA_VISIBLE_DEVICES=1 /disk2/anonymous/.venv/bin/python \
  scripts/run_question_benchmark.py --config configs/question_typod_qwen7_n500.yaml

/disk2/anonymous/.venv/bin/python scripts/analyze_question_benchmark.py \
...
```bash
/disk2/anonymous/.venv/bin/python -m pytest tests -q
```
...
/disk2/anonymous/.venv/bin/python scripts/build_rio_obj_mc.py \
...
CUDA_VISIBLE_DEVICES=2 \
PYTHONPATH=/disk2/anonymous/cta_crossvl_env/lib/python3.10/site-packages \
/disk2/anonymous/.venv/bin/python scripts/run_question_benchmark.py \
...
/disk2/anonymous/.venv/bin/python scripts/validate_question_run.py \
  --config configs/question_rio_objmc_qwen3_n100.yaml \
  --output runs/rio_objmc_qwen3_n100/completeness_audit.json

/disk2/anonymous/.venv/bin/python scripts/score_rio_official.py \
  --predictions runs/rio_objmc_qwen3_n100/predictions.jsonl \
  --rio-repo /disk2/anonymous/RIO-Bench \
...
```bash
/disk2/anonymous/.venv/bin/python scripts/extend_question_manifest.py \
...
/disk2/anonymous/.venv/bin/python scripts/run_rio_suite.py \
  --suite-config configs/rio_ctav2_discovery_suite_n100.yaml

/disk2/anonymous/.venv/bin/python scripts/select_rio_cta_template.py \
...
```bash
/disk2/anonymous/.venv/bin/python scripts/build_violation_severity_manifest.py \
...
```bash
/disk2/anonymous/.venv/bin/python scripts/build_simulated_capture.py \
...
```bash
/disk2/anonymous/.venv/bin/python -m pip install \
  --target /disk2/anonymous/ocr_engines/easyocr_deps --no-deps \
  easyocr==1.7.2 python-bidi pyclipper ninja shapely

CUDA_VISIBLE_DEVICES=6 \
PYTHONPATH=/disk2/anonymous/ocr_engines/easyocr_deps \
/disk2/anonymous/.venv/bin/python scripts/apply_secondary_ocr_defense.py \
...
CUDA_VISIBLE_DEVICES=6 /disk2/anonymous/.venv/bin/python \
...
```bash
PYTHONPATH=/disk2/anonymous/le-wm-seminar/.venv/lib/python3.10/site-packages \
/disk2/anonymous/.venv/bin/python scripts/build_rio_obj_mc.py \
...
```bash
/disk2/anonymous/.venv/bin/python scripts/prepare_scenetap_reproduction.py \
...
CUDA_VISIBLE_DEVICES=1 /disk2/anonymous/.venv/bin/python \
  ...
  --model-path /disk2/anonymous/SpaceDrive/ckpts/Qwen2.5-VL-7B-Instruct
```
...
```bash
/disk2/anonymous/.venv/bin/python scripts/build_scenetap_eval_manifest.py \
...
```bash
/disk2/anonymous/.venv/bin/python scripts/prepare_physical_capture_kit.py \
  --manifest runs/rio_ctav2_holdout_n100/render_manifest.jsonl \
...
CUDA_VISIBLE_DEVICES=5 /disk2/anonymous/.venv/bin/python \
  scripts/run_rvta_qa.py --config configs/rvtaqa_coco_test_qwen7_n250.yaml

CUDA_VISIBLE_DEVICES=6 \
PYTHONPATH=/disk2/anonymous/cta_crossvl_env/lib/python3.10/site-packages \
/disk2/anonymous/.venv/bin/python scripts/run_rvta_qa.py \
...
```bash
/disk2/anonymous/.venv/bin/python scripts/analyze_rvta_qa.py \
...
```bash
/disk2/anonymous/.venv/bin/python scripts/build_rvta_qa_balanced.py \
...
/disk2/anonymous/.venv/bin/python scripts/analyze_rvta_qa_balanced.py \
...
```bash
/disk2/anonymous/.venv/bin/python scripts/make_synthetic_natural_blind_pack.py \
