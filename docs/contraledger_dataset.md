...
independent knowledge probe supplied with the unmodified source image. The
prompt asks the model to ignore that image, but this is not an image-free
baseline. The separate channel study implements genuinely image-free calls.
