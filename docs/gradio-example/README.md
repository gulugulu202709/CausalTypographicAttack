...
The four screenshots below show the question, image comparison, model
answers, and shared diagnostics from the same archived item.
...
The repository viewer renders these screenshots as a static example. Live model
