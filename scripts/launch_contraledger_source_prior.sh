...
gpu_index="${1:-4}"
python_bin="/disk2/anonymous/.venv/bin/python"
...
for config in "${configs[@]}"; do
  ...
  case "${name}" in
    *llava*) dependency_path="/disk2/anonymous/cta_crossvl_env/lib/python3.10/site-packages" ;;
    *internvl*) dependency_path="/disk2/anonymous/cta_internvl_env/lib/python3.10/site-packages" ;;
    *) dependency_path="" ;;
  esac
