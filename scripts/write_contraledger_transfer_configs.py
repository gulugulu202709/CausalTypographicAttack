...
MODELS = {
    "qwen3": {
        "adapter": "qwen25vl",
        "name_or_path": "/path/to/local/.cache/huggingface/hub/models--Qwen--Qwen2.5-VL-3B-Instruct/snapshots/66285546d2b821cf421d4f5eb2576359d3770cd3",
        "device": "cuda:0", "dtype": "bfloat16", "min_pixels": 200704,
        "max_pixels": 602112, "max_new_tokens": 96, "do_sample": False,
    },
    "qwen7": {
        "adapter": "qwen25vl",
        "name_or_path": "/path/to/local/SpaceDrive/ckpts/Qwen2.5-VL-7B-Instruct",
        "device": "cuda:0", "dtype": "bfloat16", "min_pixels": 200704,
        "max_pixels": 602112, "max_new_tokens": 96, "do_sample": False,
    },
    "llava": {
        "adapter": "llava_onevision_1_5",
        "name_or_path": "/path/to/local/.cache/huggingface/hub/models--lmms-lab--LLaVA-OneVision-1.5-8B-Instruct/snapshots/e137910552d616eb0f7305147ca054311a90c542",
        "device": "cuda:0", "dtype": "bfloat16", "max_new_tokens": 96,
        "do_sample": False,
    },
    "internvl": {
        "adapter": "internvl2",
        "name_or_path": "/path/to/local/.cache/huggingface/hub/models--OpenGVLab--InternVL2-8B/snapshots/6fb9ad6924f69424e57fab2ab061d707688f0296",
        "device": "cuda:0", "dtype": "bfloat16", "max_new_tokens": 96,
