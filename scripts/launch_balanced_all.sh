...
ROOT=/disk2/anonymous/causal_typographic_attack
PY=/disk2/anonymous/.venv/bin/python
cd "$ROOT"
...
(
  ...
  export PYTHONPATH=/disk2/anonymous/cta_crossvl_env/lib/python3.10/site-packages
...
(
  ...
  export PYTHONPATH=/disk2/anonymous/cta_internvl_env/lib/python3.10/site-packages
