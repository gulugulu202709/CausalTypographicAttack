...
## ICLR code-release preparation (2026-09-23)

- [x] Inventory public evidence, environment snapshots and missing assets.
- [x] Separate the primary entry point from historical experiment notes.
- [x] Correct Knowledge probe description and portable configuration templates.
- [x] Validate CPU replay, export integrity and scoped regression suite: six replays; 90 tests passed, one Linux-font test skipped on Windows.
- [x] Record final checks and remaining release blockers in submission_readiness.md.
